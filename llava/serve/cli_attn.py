...
def main(args):
    ...
    while True:
        ...
        if args.attn_path is not None:
            os.makedirs(os.path.dirname(args.attn_path), exist_ok=True)
        ...
        with torch.inference_mode():
            ...
            torch.save(save_dict, args.attn_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--attn-path", type=str, default=None)
